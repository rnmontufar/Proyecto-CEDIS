...
<html lang="en">
  <head>
    ...
    <title>.: Library-cedis v1.0 :.</title>
    ...
    <div id="wrapper">
      ...
      <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        ...
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="./">Library-CEDIS <sup><small><span class="label label-info">v1.0</span></small></sup> </a>
        </div>
...
?>
         <ul class="nav navbar-nav">
           ...
           <ul class="nav navbar-nav side-nav">
              ...
              <?php if($u->is_admin):?>
              <li><a href="index.php?view=reports"><i class="fa fa-area-chart"></i> Solicitudes</a></li>
